...
var sewingBtn, blankBtn = tb.ReplyButton{Text: l10n["Sewing"]},
...
var adminNew, adminProgress, adminDone = tb.ReplyButton{Text: "Новые"},
...
var anotherBtn, finOrderBtn = tb.ReplyButton{Text: "Оформить еще один заказ"},
...
var jpegBtn, dunnoBtn = tb.ReplyButton{Text: l10n["jpeg"]},
...
var newOrderBtn, contactsBtn, myordersBtn = tb.ReplyButton{Text: l10n["NewOrder"]},
