...
var l10n = map[string]string{
	...
	"not_admin":      "Эй, вы не администратор! Давайте лучше сделаем заказ!",
	"admin":          "Привет, Мастер! Чем я могу вам помочь?",
	"empty":          "Ого, так пусто. Похоже ничего нету!",
